        ...
        <PageContent>
            <Wrapper>
                <Forms>
                    ...
                    <ReservationDetails>
                        <Input type="time" min="09:00" max="19:00" label="Godz. rozpoczęcia" name="startTime"/>
                ...
                <OrderContent>
                    ...
                    <Button text="Dodaj rezerwację" bgColor={colors.primary} textColor="white" hoverColor={colors.primaryHover}/>
                </OrderContent>
            </Wrapper>
        </PageContent>
    );
